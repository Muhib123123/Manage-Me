...
export const metadata: Metadata = { title: "Instagram Dashboard" };
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6 mb-12">
                <div>
                    ...
                    <p className="text-[var(--muted)] text-base max-w-lg leading-relaxed">
                        Manage your scheduled photos, videos, and Reels for Instagram, track analytics, and monitor performance.
                    </p>
                </div>
                <Link href="/instagram-dashboard/upload" className="w-full sm:w-auto px-6 py-3 uppercase tracking-wider bg-[var(--text)] hover:bg-[var(--text)]/90 text-[var(--surface)] font-bold text-xs rounded-full transition-all shadow-md hover:shadow-lg dark:shadow-none text-center flex items-center justify-center cursor-pointer">
                    Schedule New Post <span className="ml-2 text-lg leading-none">+</span>
                </Link>
            </div>
            ...
            <DashboardTabs
                ...
                analyticsContent={
                    <AnalyticsDashboard platform="INSTAGRAM" />
                }
            />
        </div>
    );
