...
/* ─── Main Form ───────────────────────────────────── */
export default function InstagramUploadFormClient({ accountName }: { accountName: string }) {
        ...
        <div className="p-6 md:p-10 max-w-[1000px] mx-auto">
            ...
            <div className="mb-12 md:mb-16">
                ...
                <p className="text-[var(--muted)] text-sm md:text-base max-w-2xl leading-relaxed">
                    Upload your media and schedule it to publish to <strong>@{accountName}</strong>.
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-10 md:gap-14">
                ...
                <FormCard title="Caption & Metadata">
                    <div className="flex flex-col gap-2.5">
                        ...
                        <textarea
                            ...
                            maxLength={2200}
                            rows={6}
                            placeholder="Write a caption... mention users with @ and add hashtags with #"
                ...
                {submitStatus === "done" && (
                    <div className="px-5 py-4 rounded-xl bg-[var(--surface-2)] text-[var(--text)] text-sm font-medium border border-[var(--border-solid)] flex items-center gap-3">
                        ...
                        Post successfully scheduled to Instagram!
                    </div>
                )}
